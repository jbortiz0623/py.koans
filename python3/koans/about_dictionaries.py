...
class AboutDictionaries(Koan):
    ...
    def test_dictionary_keys_and_values(self):
        ...
        self.assertEqual('one' in  babel_fish.keys(), 'one' in babel_fish.keys())
        self.assertEqual('two' in babel_fish.values(), 'two' in babel_fish.values())
        self.assertEqual('uno' in babel_fish.keys(), 'uno' in babel_fish.keys())
        self.assertEqual('dos' in babel_fish.values(), 'dos' in babel_fish.values())
